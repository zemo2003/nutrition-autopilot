...
const CATEGORY_KEYWORDS: Record<FoodCategory, RegExp> = {
  ...
  DAIRY: /\b(milk|cheese|yogurt|cream|whey|lactose|casein|ricotta|cottage|mozzarella|cheddar|feta|gouda|parmesan|kefir|sour cream)\b/i,
  EGGS: /\b(eggs?|albumen)\b(?!plant)/i,
  GRAINS_CEREALS: /\b(rice|pasta|bread|oats?|cereal|wheat|flour|barley|rye|corn|polenta|couscous|quinoa|millet|sorghum|buckwheat)\b/i,
  ...
  NUTS_SEEDS: /\b(almonds?|walnuts?|peanuts?|peanut butter|cashews?|pecans?|macadamia|pistachios?|hazelnuts?|pine nuts?|seeds?|sesame|sunflower|pumpkin seeds?|flax|chia|hemp)\b/i,
